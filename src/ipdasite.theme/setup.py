...
_name            = 'ipdasite.theme'
_version         = '2.1.9'
_description     = 'International Planetary Data Alliance Site Theme'
_url             = 'http://pypi.python.org/pypi/ipdasite.theme/'
...
_zipSafe         = False
_keywords        = 'web zope plone planetary data science theme style'
_testSuite       = 'ipdasite.theme.tests.test_suite'
